...
namespace GraduationProject
{
    public static class CurrentContext
    {
        ...
        public static List<MeasureValueModel> MeasureValues = new List<MeasureValueModel>
        {
            ...
            new MeasureValueModel {Id = 2, Name = "РКП", TemplateColumns = new List<TemplateColumn> { new TemplateColumn {Name = "X", BindingName = "X"}, new TemplateColumn { Name = "Y", BindingName = "Y" }, new TemplateColumn { Name = "Горизонт. дистанция", BindingName = "HorizontalDistance" }, new TemplateColumn { Name = "Верт. дистанция", BindingName = "VerticalDistance" }, new TemplateColumn { Name = "Наклон. дистанция", BindingName = "SlopeDistance" }, new TemplateColumn { Name = "Азимут", BindingName = "Azimuth" }, new TemplateColumn { Name = "Уклон", BindingName = "Bias" }, new TemplateColumn {Name = "Диаметр №1", BindingName = "DiameterOne" } }},
            new MeasureValueModel {Id = 3, Name = "ППП", TemplateColumns = new List<TemplateColumn> { new TemplateColumn { Name = "Горизонт. дистанция", BindingName = "HorizontalDistance" }, new TemplateColumn { Name = "Верт. дистанция", BindingName = "VerticalDistance" }, new TemplateColumn { Name = "Наклон. дистанция", BindingName = "SlopeDistance" }, new TemplateColumn { Name = "Азимут", BindingName = "Azimuth" }, new TemplateColumn { Name = "Уклон", BindingName = "Bias" }, new TemplateColumn { Name = "Диаметр №1", BindingName = "DiameterOne" }, new TemplateColumn {Name = "Диаметр №2", BindingName = "DiameterTwo" } }},
            new MeasureValueModel {Id = 4, Name = "ВПП", TemplateColumns = new List<TemplateColumn> { new TemplateColumn { Name = "Верт. дистанция", BindingName = "VerticalDistance" }, new TemplateColumn { Name = "Азимут", BindingName = "Azimuth" }, new TemplateColumn {Name = "Диаметр №1", BindingName = "DiameterOne" } }}
        };
